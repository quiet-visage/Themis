...
#define SUPPORT_MODULE_RTEXT \
    1  // WARNING: It requires SUPPORT_MODULE_RTEXTURES to load sprite font textures
...
// timing + PollInputEvents() Enabling this flag allows manual control of the frame processes, use
// at your own risk
